        ...
        <div className="wrap-1 sf-1">
          ...
          <div className="about__info">
            <p>
              ...
              <a href="https://www.sfu.ca/siat.html">
                School of Interactive Arts and Technology
              </a>{" "}
              and recent grad from{" "}
              <a href="https://redacademy.com/">RED Academy</a>.
            </p>
            <p>
              I’m interested in learning to create design systems and producing
              work in interdisciplinary teams to absorb knowledge through
              osmosis.
            </p>
          </div>
          ...
          <div className="about__resume">
            <ResumeItem
              ...
              date="Oct 2019 - Mar 2020 in Vancouver"
            ...
            >
              Leading lessons on Sketch and other technical skills. Supporting
              students during workshop hours by providing design feedback and
            ...
            >
              Supported development team for a medical information system
              interface with wireframes and design specifications. Prototyped
              basic web interface using Angular2 with mentorship of a developer.
            </ResumeItem>
            <ResumeItem
            ...
            >
              Prototyped interfaces in Unity for Match 3 games, supported
              developers by implementing interface and performing QA tests.
              Worked with Art Director to concept a wayfinding application for
              airports.
            </ResumeItem>
            <ResumeItem
              href="www.visier.com"
            ...
            >
              Supported feature development alongside developers with design
          ...
          <div className="about__info">
            <p>
              I believe that good design is effective communication with the
              people on the other side of my work.
            </p>
            <p>
              My off hours include{" "}
              <a href="https://www.twitch.tv/icytan">streaming on Twitch</a>,{" "}
              <a href="https://www.instagram.com/getpatlau/">baking</a> for my
              collaborators, and playing in{" "}
              <a href="https://magic.wizards.com/en">Magic the Gathering</a>{" "}
              tournaments.
            </p>
            <p>
              I wrote this website with{" "}
              <a href="https://www.gatsbyjs.org/">Gatsby.js</a> and is powered
              by <a href="https://www.netlify.com">Netlify</a>. You can find my
              long form case studies in the wild{" "}
              <a href="https://medium.com/@get.patlau">on Medium</a> and my code
              work on{" "}
              <a href="https://github.com/icyTan/portfolio2019">Github</a>.
            </p>
          </div>
          <PrimaryButton
